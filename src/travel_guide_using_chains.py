...
prompt = PromptTemplate(
    ...
    template="""
    Create a travel itinerary for {place} for {days} days. What are the must visit attractions during {month} and list some useful phrases in their local language.
    """
)
